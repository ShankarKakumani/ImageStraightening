...
package com.example.imagestraightening.crop;
...
import com.example.imagestraightening.R;
import com.example.imagestraightening.Utils;
...
public class CropImageActivity extends AppCompatActivity
    implements CropImageView.OnSetImageUriCompleteListener,
        CropImageView.OnCropImageCompleteListener, Utils.OnRulerPositionChanged {
  ...
  public void onCreate(Bundle savedInstanceState) {
    ...
    RecyclerView rulerView = findViewById(R.id.rulerRecycler);
    MaterialTextView rulerTV = findViewById(R.id.rulerPositionTV);

    Utils.INSTANCE.initRecyclerViews(this, rulerView, rulerTV, this);
  ...
  public void onPositionChanged(int position) {
    mCropImageView.straightenImage(position);
  }
