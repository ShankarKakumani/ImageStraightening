...
public class CropImageView extends FrameLayout {
  ...
  public void straightenImage(int degrees) {
    ...
    float newX = (mImageView.getWidth() / 2F) * (1 - scale);
    float newY = (mImageView.getHeight() / 2F) * (1 - scale);
    matrix.postScale(scale, scale);
    matrix.postTranslate(newX, newY);
    matrix.postRotate(angle, mImageView.getWidth() / 2F, mImageView.getHeight() / 2F);
